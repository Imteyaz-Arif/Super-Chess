...
**🚀 Live Application:** [https://superchess12.vercel.app/](https://superchess12.vercel.app/)
...
- **Smooth Animations**: Powered by Framer Motion and canvas-confetti for a premium, life-like board experience.
- **Mobile Optimized**: Intelligently auto-scales the chessboard and sidebar for a perfect experience on smartphone screens.

## 🛠️ Technology Stack
- **Framework**: Next.js 16 (App Router)
- **Real-time**: Ably Realtime SDK
- **Logic**: Chess.js (Rules engine) & React-Chessboard
